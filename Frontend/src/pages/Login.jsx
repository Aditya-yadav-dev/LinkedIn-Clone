...
return (
  <div className='w-screen h-screen bg-white flex flex-col justify-center items-center gap-[10px] relative'>
      <div className='p-[25px] lg:p-[33px] w-full h-20 flex items-start absolute top-3'>
          <img src={logo} alt="" />
      </div>
      <form onSubmit={handleSignIn} className='w-[90%] max-w-[400px] h-[400px] md:shadow-2xl flex flex-col justify-center gap-4 p-4 rounded-xl'>
         <h1 className='text-gray-800 text-3xl font-semibold mb-6'>Sign In</h1>
